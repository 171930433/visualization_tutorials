...
DataTableDisplay::DataTableDisplay() {
  ...
  //
  data_channel_ = new rviz_common::properties::CachedChannelProperty("data_channel", "", "data_channel", this, SLOT(UpdateChannel()));

  main_interval_ = new rviz_common::properties::IntProperty("interval", 100, "main grid interval[5,1000]", this, SLOT(UpdateInterval()));
  main_interval_->setMin(5);
  main_interval_->setMax(1000);
  sub_range_ = new rviz_common::properties::IntProperty("range", 100, "sub grid range [10,100]", this, SLOT(UpdateRange()));
...
PLUGINLIB_EXPORT_CLASS(DataTableDisplay, rviz_common::Display)